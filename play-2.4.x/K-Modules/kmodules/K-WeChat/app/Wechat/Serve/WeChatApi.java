...
public class WeChatApi {
    ...
    public static String WeChatToken() {
        return Configuration.root().getString("WeChat.Token", "EBF802EC8463460B8FADBB4C5838F8DA");
    }

    public static String EncodingAESKey() {
        return Configuration.root().getString("WeChat.EncodingAESKey", "Cp1SFHmMDHtOrkp9DUevjXXOmWBHCbPPYesG87Da0Cx");
    }

    public static String AppID() {
        return Configuration.root().getString("WeChat.AppID", "wxb31aa0ff54f60d1f");
    }

    public static String AppSecret() {
        return Configuration.root().getString("WeChat.AppSecret", "ef5c448ea289f3176e9bd62b7f8354a8");
    }
    ...
    public static JsonNode LocalMenuConfig() {
        try {
            ...
            String menu_conf = FileTemplateHelper.Process("/WeChat/Menu.conf", conf);
