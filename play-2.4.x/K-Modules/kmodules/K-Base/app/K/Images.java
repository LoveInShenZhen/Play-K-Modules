...
//    }
    ...
    public static class ImageCaptcha extends InputStream implements TextProducer {
        ...
        static final int DEFAULT_WIDTH = Configuration.root().getInt("captcha_Width", 150);
        static final int DEFAULT_HEIGHT = Configuration.root().getInt("captcha_Height", 50);
        static final int TextLength = Configuration.root().getInt("captcha_Text_Length", 4);
        static final int TextMarginBottom = Configuration.root().getInt("captcha_Text_MarginBottom", 15);
        static final int TextMarginLeft = Configuration.root().getInt("captcha_Text_MarginLeft", 10);
        ...
        static final String GradiatedFromColor = Configuration.root().getString("captcha_Background_Gradiated_FromColor", "#EDEEF0");
        static final String GradiatedToColor = Configuration.root().getString("captcha_Background_Gradiated_ToColor", "#C5D0E6");
        static final boolean BackgroundFlatColor = ConfGetBool("captcha_Background_FlatColor", false);
        static final String FlatColor = Configuration.root().getString("captcha_Background_FlatColor_Color", "#EDEEF0");
        ...
        static final int BlockGimpyBlockSize = Configuration.root().getInt("captcha_GimpyRenderer_BlockGimpyRenderer_BlockSize", 1);
        static final boolean DropShadowGimpyRenderer = ConfGetBool("captcha_DropShadowGimpyRenderer", false);
        static final int DropShadowGimpyRadius = Configuration.root().getInt("captcha_DropShadowGimpyRenderer_Radius", 3);
        static final int DropShadowGimpyOpacity = Configuration.root().getInt("captcha_DropShadowGimpyRenderer_Opacity", 75);
        static final boolean CurvedLine = ConfGetBool("captcha_Noise_CurvedLine", false);
        static final int CurvedLineWidth = Configuration.root().getInt("captcha_Noise_CurvedLine_Width", 2);
        static final String CurvedLineColor = Configuration.root().getString("captcha_Noise_CurvedLine_Color", "#2795EA");
        ...
        static {
            List<String> colors = Configuration.root().getStringList("captcha_Font_Colors");
            if (colors == null) {
            ...
            List<String> fonts = Configuration.root().getStringList("captcha_Fonts");
            if (fonts == null) {
        ...
        public static boolean ConfGetBool(String key, boolean defaultValue) {
            String v = Configuration.root().getString(key);
